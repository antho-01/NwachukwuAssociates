...
import styles from "@/app/trending/page.module.css"
...
<div className={styles.forsale}> <h1  data-aos="fade-left"> Trending Market </h1> </div>
                                ...
                                <div className={styles.subContainer}>
                                      ...
                                      <div className={styles.imageDes}>
                                            ...
                                            <div className={styles.imgContainer}>
                                                  <Link href={`/trending/${list.id}`}> <Image src={list.image} layout="fill" alt="House"/></Link>
                                            </div>
